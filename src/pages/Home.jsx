      ...
      <section className="section subscribe-section">
        <div className="container">
          ...
          <div className="platform-buttons">
            <a href="https://podcasts.apple.com/us/podcast/night-swim-podcast/id1853013593" target="_blank" rel="noopener noreferrer" className="platform-button">
            ...
            <a href="https://www.youtube.com/@NightSwimPod" target="_blank" rel="noopener noreferrer" className="platform-button">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://open.spotify.com/show/5jeYpru0iqfbtmhDg56IoI" target="_blank" rel="noopener noreferrer" className="platform-button">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
